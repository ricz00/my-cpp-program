...
int main(){
	...
	if(number >= 1 && number <= 12){
		if (number == 1)
		    cout<<"1 is January - The month of new beginnnings.\n\n";
	else if (number == 2)
		    cout<<"2 is Febrary- The month of love.\n\n";
    else if (number ==3)        
	        ...
	        cout<<"8 is August - The month of hardworking.\n\n";		
         	...
         	cout<<"9 is September - The month of exam.\n\n";		
	else if (number == 10)		
		cout<<"10 is Ocbober - The month of celebration.\n\n";		
	else if (number == 11)		
	    cout<<"11 is November - The month of souls.\n\n";		
	else if (number == 12)	
	     cout<<"12 is 12 - The month of giving.\n\n";		
}else
